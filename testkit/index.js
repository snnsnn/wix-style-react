...
export const PopoverMenuTestkitFactory = uniTestkitFactoryCreator(load(require('../src/Beta/PopoverMenu/PopoverMenu.uni.driver')));
...
export const editableRowTestkitFactory = uniTestkitFactoryCreator(load(require('../src/EditableSelector/EditableRow/EditableRow.driver')));
