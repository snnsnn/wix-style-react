...
export const PopoverMenuTestkitFactory = enzymeUniTestkitFactoryCreator(load(require('../src/Beta/PopoverMenu/PopoverMenu.uni.driver')));
...
export const editableRowTestkitFactory = enzymeUniTestkitFactoryCreator(load(require('../src/EditableSelector/EditableRow/EditableRow.driver')));
