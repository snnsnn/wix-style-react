...
<details>
  ...
  | topContainerClass| object   | -            | -          | react class object - applying style on the top container |
  | containerClass   | object   | -            | -          | react class object - applying style on any container in the tree|
  | itemClass         | object   | -            | -          | react class object -applying style on item wrapper |
